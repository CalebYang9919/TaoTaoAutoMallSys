<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Inherits="Taotaonetwork.SearchProduct" %>
            ...
            <div class="content-wrapper">
                <div class="content-top">
                    <div class="box_wrapper">
                        <h2>搜索商品-<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                            <% if (bool.Parse(Session["show"].ToString()))
                               {%><span style="font-size: 22px;">&nbsp;&nbsp;&nbsp;你要找的是不是:<asp:LinkButton ID="LinkButton1" runat="server"></asp:LinkButton></span>
                            <%}%> </h2>
                    </div>
                                    ...
                                    <div class="grid_1">
                                        ...
                                        <div class="grid_desc">
                                            ...
                                            <div class="cart-button">
                                                ...
                                                <a href='Details.aspx?productid=<%#Eval("id") %>'><input class="button" type="button" value="详情" /></a>
                                                <div class="clear"></div>
                                            </div>
                                        </div>
                                    </div>
