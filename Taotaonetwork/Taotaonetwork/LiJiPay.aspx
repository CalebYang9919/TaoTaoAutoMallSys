<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LiJiPay.aspx.cs" Inherits="Taotaonetwork.LiJiPay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $("#pay").click(function () {
            ...
            location.href = "LiJiPayment.aspx?cid=" + cid + "&price=" + price + "&pid=" + '<%=Session["pid"]%>' + "&num=" + '<%=Session["num"]%>';
        })
