<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Taotaonetwork.Payment" %>
            ...
            <div class="content-wrapper">
                <div class="content-top">
                    ...
                    <div class="text">
                        ...
                        <h3 style="margin-left: 70px;">应付金额：<span style="color: #d0c9c9; font-size: 28px;">￥</span><span style="color: red; font-size: 28px;" name="prices"><%=price %></span>
                        </h3>
